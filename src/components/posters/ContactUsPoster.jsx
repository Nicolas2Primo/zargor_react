...
const ContactUsPoster = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full ">
      <div className="w-[270px] h-[400px] py-6 px-3 md:h-[400px] md:w-[600px] lg:w-[900px] md:w-min-[600px]  contact_poster_background rounded-[11.3391px] flex flex-col  items-center justify-center">
