...
const Section = ({ section_title, section_subtitle, poster, about_poster }) => {
  return (
    <div className="flex flex-col gap-16 mx-[22px] md:mx-[48px] border-y-[2px] h-[101vh] border-white border-opacity-40 py-28 text-white justify-center">
      ...
      <div className="flex justify-center w-screen md:justify-start">
        {poster == true ? (
          <Poster />
        ) : about_poster == true ? (
          <AboutPoster />
